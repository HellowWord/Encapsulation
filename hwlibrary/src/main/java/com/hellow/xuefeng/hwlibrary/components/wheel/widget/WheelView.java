...
package com.hellow.xuefeng.hwlibrary.components.wheel.widget;
...
import com.hiersun.dmbase.R;
import com.hiersun.dmbase.components.wheel.widget.adapters.WheelViewAdapter;
...
//		centerDrawable.draw(canvas);
        ...
        paint.setColor(getResources().getColor(R.color.wheel_cut_line));
        // 设置线宽
